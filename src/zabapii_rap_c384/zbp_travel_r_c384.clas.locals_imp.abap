...
CLASS lhc_Travel IMPLEMENTATION.
    ...
    LOOP AT travels INTO DATA(travel). "70021
      ...
      IF travel-AgencyID IS NOT INITIAL.
        ...
        IF update_requested EQ abap_true.
          IF lv_technical_name EQ 'CB9980007474' AND travel-AgencyID NE '70021'. "REPLACE WITH BUSINESS LOGIC
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF Ztravel_r_c384 IN LOCAL MODE
      ENTITY Travel
      UPDATE
      FIELDS ( OverallStatus )
  ...
  METHOD deductDiscount.
    ...
    DATA travels_for_update TYPE TABLE FOR UPDATE Ztravel_r_c384.
  ...
  METHOD setTravelNumber.
    ...
    SELECT SINGLE FROM ztravel_c384_a
