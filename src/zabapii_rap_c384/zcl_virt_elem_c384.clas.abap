CLASS zcl_virt_elem_c384 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_c384 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~calculate.

    DATA: lt_original_data TYPE STANDARD TABLE OF ztravel_c_c384 WITH DEFAULT KEY.
    ...
    CASE iv_entity.
      ...
      WHEN 'ZTRAVEL_C_C384'.
        ...
        LOOP AT it_requested_calc_elements INTO DATA(ls_requested_calc_elements).
          ...
          IF ls_requested_calc_elements = 'PRICEWITHVAT'.
